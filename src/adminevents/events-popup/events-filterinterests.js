...
const FilterEventsInterests = () =>
{
    ...
    return(
       ...
       <button className='btn-btn-green13 d-flex align-items-center' style={items.css} >
        {index == 0 ?
...
export default FilterEventsInterests