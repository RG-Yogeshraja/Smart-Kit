...
const FilterEventsSortby = () => {
    ...
    const handlechange = (index) => {
      ...
      const handlechange3 = (index) => {
        ...
        if (newTags3[index].checking === true)
        {
    ...
    return (
        <>
          ...
          <div className='col-12 mt-2 mb-1'>
                <span className='font-groups13'>Sort By</span>
            </div>
            <div className='mb-2'>
                <span className='font-events'>Event Name</span>
                </div>
                <form className="row">
     ...
     <img onClick={() => {handlechange(index) }} src={items.checking ?checkblankboxes:checktickboxes} width="20px" height="20px"></img>&nbsp;&nbsp;
       ...
       <span style={items.css} className='fonting-style13 col-9'>{items.naming} </span><br></br>
            ...
            <div className='mb-2'>
                <span className='font-events'>Event Date</span>
            </div>
            <form className="row">
     ...
     <img onClick={() => {handlechange1(index) }} src={items.checking ?checkblankboxes:checktickboxes} width="20px" height="20px"></img>&nbsp;&nbsp;
       ...
       <span style={items.css} className='fonting-style13 col-9'>{items.naming} </span><br></br>
            ...
            <hr style={{color:"#CCD8DB"}}></hr>
            <div className='mb-2'>
                <span className='font-events'>Event Creation Date</span>
            </div>
            <form className="row">
     ...
     <img onClick={() => {handlechange2(index) }} src={items.checking ?checkblankboxes:checktickboxes} width="20px" height="20px"></img>&nbsp;&nbsp;
       ...
       <span style={items.css} className='fonting-style13 col-9'>{items.naming} </span><br></br>
            ...
            <hr style={{color:"#CCD8DB"}}></hr>
            <div className='mb-2'>
                <span className='font-events'>Members Attending</span>
            </div>
            <form className="row">
...
export default FilterEventsSortby