...
const EditEventInterests = (props) => {
            ...
            <div className='d-flex flex-row mb-1'>
                {intersetarr1.map((items, index) => <div key={index} className="me-50">
                    <div className='d-flex justify-content-start align-items-start'>
                        <button style={items.css} className='btn-btn-green1 d-flex align-items-center justify-content-center px-1' onClick={() => popularclick(items, index)}>
...
export default EditEventInterests
