...
<div className="mb-1">
       <InputRange  
        ...
        /> </div> */}
            ...
            <div>
              <img src={croppedImage != undefined ? croppedImage : edituser1} width="300px" height="300px" style={{ borderRadius: '10px' }}></img>

              <input className="d-none" type="file" accept='.jpg,.png' ref={inputRef} onChange={onFileChange} onClick={handleShow}></input>
              <img src={editcamera} width="40px" height="40px" style={{ marginTop: "41%", marginLeft: "-10%" }} onClick={handleUpload}></img>
            </div>
         
      {/* ) : (

        <div>
          <img src={croppedImage == undefined ? edituser1 : croppedImage} width="300px" height="300px" style={{ borderRadius: '10px' }}></img>
