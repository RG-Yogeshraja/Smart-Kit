...
import blankimagee from '../../assets/images/dashboardimg/blank-image.png'
...
<div className="mb-1">
      ...
      <div className='mb-2'>
        <img src={croppedImage != undefined ? croppedImage : blankimagee} width="359px" height="359px" style={{ borderRadius: '10px' }}></img>

        <input className="d-none" type="file" accept='.jpg,.png' ref={inputRef} onChange={onFileChange} onClick={handleShow}></input>
        <img src={editcamera} width="66px" height="66px" style={{ top:'250px', left:'185px', position:'absolute' }} onClick={handleUpload}></img>
        <span className='font-white-camera  absolutivelyyy' >Tap to upload images or videos</span>
      </div>

      {/* ) : (

        <div className='mb-2'>
        <img src={croppedImage == undefined ? blankimagee : croppedImage} width="359px" height="359px" style={{ borderRadius: '10px' }}></img>

       <input className="d-none" type="file" accept='.jpg,.png' ref={inputRef} onChange={onFileChange} onClick={handleShow}></input>
        <img src={editcamera} width="66px" height="66px" style={{ marginTop: "-2%", marginLeft: "-30%" }} onClick={handleUpload}></img>
        <span className='font-white-camera  absolutivelyyy ' >Tap to upload images or videos</span>
       </div>
       )} */}
...
export default EventsAddcropDemo;
