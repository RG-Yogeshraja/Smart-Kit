...
const FilterDrinking = () =>
{

    const [tags, setTags] = useState([
    {id:"1",naming:'Frequently' ,checking:true},
    {id:"2",naming:'Socially',checking:true,css:{marginLeft:'-40px'}},
    {id:"3",naming:'Never',checking:true},
    {id:"4",naming:'Sober',checking:true,css:{marginLeft:'-40px'}},
...
const handlechange = (index) => {
  ...
  setTags(newTags);
    ...
    return(
        ...
        <span className='loc'>Drinking</span> 
