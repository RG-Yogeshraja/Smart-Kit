...
import edit_logo7 from '../assets/images/dashboardimg/edit-logo7.png'

const EditLanguages = () => {
    const [languages, setlanguages] = useState([{ name: 'English' }, { name: 'Spanish', css: { marginLeft: '-60px' } }])
    ...
    return (
        <>
            <div className='d-flex justify-content-between flex-row mb-2'>
                <div>
                    <img src={edit_logo7} width="20px" height="20px"></img>&nbsp;&nbsp;
                    <span className='loc-text ms-75'>Languages</span>
                </div>
                <div>
            ...
            <div className='row'>
                {languages.map((items, index) => <div key={index} className="col-2 me-25 ">
