...
const FilterPolitics = () =>
{
    ...
    {id:"2",naming:'Moderate',checking:true,css:{marginLeft:'-40px'}},
    // {id:"",naming:null , checking:null},
    {id:"4",naming:'Conservative',checking:true},
    {id:"5",naming:'Apolitical',checking:true,css:{marginLeft:'-40px'}},
...
const [showLess, setshowLess] = useState(true);
    ...
    return(
        ...
        <span className='loc'>Politics</span> 
