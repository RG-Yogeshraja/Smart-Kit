...
import '../../src/@core/scss/base/adminDashboard/groupsmenu/filtergrouppopup.scss'
// src\@core\scss\base\adminDashboard\groupsmenu\filtergrouppopup.scss
...
//
    ...
    return (
               ...
               <button className='btn-btn-green11 me-50 mt-1' style={items.css}>
                ...
                <img  src={items.img2} width="20px" height="20px" disabled={() => clickapi(index, items)}></img>
               </button>
        </div>
        ...
        <img className='search ms-1' src={search} width="20px" height="20px"></img>
                    ...
                    {suggestions && suggestions.map((sug, i) => {
                        ...
                        <div className='mb-50 mt-50 mx-2 ' style={{cursor:'pointer'}} disabled={() => changeval(sug.name, i)} key={i}><span className='textspan1' >{sug.name}</span></div>
            ...
            <div className='d-flex flex-row mb-1'>
                {intersetarr1.map((items, index) => <div key={index} className="me-50">
                    <div className='d-flex justify-content-start align-items-start'>
                        <button style={items.css} className='btn-btn-green1 d-flex align-items-center justify-content-center px-1' disabled={() => popularclick(items, index)}>
