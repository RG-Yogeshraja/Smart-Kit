...
const SponsorsgroupsEditcropDemo = () => {
...
<div className="mb-1">
       <InputRange  
        ...
        /> </div> */}
            ...
            <div>
              <img src={croppedImage != undefined ? croppedImage : sponsorgroupimg01} width="359px" height="359px" style={{ borderRadius: '10px' }}></img>

              <input className="d-none" type="file" accept='.jpg,.png' ref={inputRef} onChange={onFileChange} onClick={handleShow}></input>
              <img src={editcamera} width="56px" height="56px" style={{ marginTop: "-10%", marginLeft: "75%" }} onClick={handleUpload}></img>
      ...
      {/* ) : (
        ...
        <div>
          <img src={croppedImage == undefined ? sponsorgroupimg01 : croppedImage} width="359px" height="359px" style={{ borderRadius: '10px' }}></img>
...
export default SponsorsgroupsEditcropDemo;
