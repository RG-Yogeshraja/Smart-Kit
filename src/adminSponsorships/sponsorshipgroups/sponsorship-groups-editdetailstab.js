...
import addnewimage1 from '../../../src/assets/images/dashboardimg/addnewimage.png'
import editssponsorgroup from '../../../src/assets/images/dashboardimg/imagespast.png'
...
import SponsorsgroupsEditcropDemo from "./sponsorseditcropprofile1"


const SponsorshipGroupsEditDetailsTab = (props) => {
            ...
            <div className="mt-2 pt-25">
                {/*  <div className="" style={{ width: "55%" }}>
                    <div className="d-flex flex-column align-items-center py-5">
                        <img className="mb-2 mt-5" src={addnewimage1} width="56px" height="56px" />
                ...
                <div className="d-flex flex-column" style={{ width: "45%" }}>
                    {/* <img className="" src={sponsorgroupimg01} width="359px" height="398px" />
                    <img className="ms-auto addnewimage-section" src={addnewimage1} width="56px" height="56px" /> */}
                    <SponsorsgroupsEditcropDemo></SponsorsgroupsEditcropDemo>
                </div>
                <div className="row mt-1">
                    <div className="col-6 d-flex flex-column">
                        <span className="mt-75 sponsor-textspanlight13">Group Name</span>
                        <input className="formControl sponsorgroup-inputinfo" defaultValue="Dog Lovers" placeholder="Add group name..."></input>
                    </div>
                    <div className="col-6 d-flex flex-column">
                        <span className="mt-75 sponsor-textspanlight13">Location</span>
                        <input className="formControl sponsorgroup-inputinfo" defaultValue="Boston, MA" placeholder="Add city and state..."></input>
                    </div>
                </div>
                ...
                <div className="col-12 ">
                    <textarea placeholder="Add a description..." defaultValue="For doggos and the people who love them to get together and socialize " className="w-100 formControl sponsorgroup-inputinfo" style={{ height: "104px" }}>
                    </textarea>
                </div>
...
export default SponsorshipGroupsEditDetailsTab