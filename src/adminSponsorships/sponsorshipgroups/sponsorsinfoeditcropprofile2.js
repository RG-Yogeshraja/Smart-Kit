...
const SponsorsgroupsInfooEditcropDemo = () => {
...
<div className="mb-1">
       <InputRange  
        ...
        /> </div> */}
            ...
            <div>
              <img src={croppedImage != undefined ? croppedImage : editsponsorinfoimg} width="320px" height="310px" style={{ borderRadius: '10px' }}></img>

              <input className="d-none" type="file" accept='.jpg,.png' ref={inputRef} onChange={onFileChange} onClick={handleShow}></input>
              <img src={editcamera} width="56px" height="56px" style={{ marginTop: "85%", marginLeft: "-28%" }} onClick={handleUpload}></img>
      ...
      {/* ) : (
        ...
        <div>
          <img src={croppedImage == undefined ? editsponsorinfoimg : croppedImage} width="320px" height="310px" style={{ borderRadius: '10px' }}></img>
