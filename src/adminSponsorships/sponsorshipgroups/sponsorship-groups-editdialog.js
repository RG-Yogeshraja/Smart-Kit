...
import SponsorshipGroupsEditDetailsTab from "./sponsorship-groups-editdetailstab"
import SponsorshipGroupsEditInfoTab from "./sponsorship-groups-editinfotab"
import '../../../src/@core/scss/base/adminDashboard/sponsorshipsmenu/sponsorgroupsmenu/sponsorgroupsmain.scss'
import editicon from '../../assets/images/dashboardimg/editmenu.png'
const SponsorshipGroupsEditDialog = (props) => {
    ...
    return (
        <>
            ...
            <img src={editicon} width="44px" height="44px" onClick={handleShow}
                className='mt-75 editingbtn' style={{display:props.data1==true?'':'none'}}></img>
            ...
            <Modal dialogClassName="sponsorshipgroupsInfo-custommodal"
                ...
                <div className="p-3">
                    ...
                    <TabContent className="mb-2" activeTab={active}>
                        <TabPane tabId="1">
                            <SponsorshipGroupsEditDetailsTab im={image}></SponsorshipGroupsEditDetailsTab>
                        ...
                        <TabPane tabId="2" >
                            <SponsorshipGroupsEditInfoTab></SponsorshipGroupsEditInfoTab>
                            <div className='col-12 d-flex justify-content-center mt-3 mb-2'>
...
export default SponsorshipGroupsEditDialog