...
import pastgroupimg1 from "../../../src/assets/images/dashboardimg/pastgroupimg1.png"
import pastgroupimg2 from "../../../src/assets/images/dashboardimg/pastgroupimg2.png"
...
const SponsorshipGroupsPastTab = () => {
    const [activeGroupData] = useState([
        { id: 1, groupName: "Rooftop Rose Tasting", imageName: pastgroupimg1, groupStatus: "Private", location: "South Boston/Dorchester, MA", membersCount: "42 Members", duration: "June 10-14", sponsoredPosts: "13", sponsoredEvents: "3" },
        { id: 2, groupName: "Live Music", imageName: pastgroupimg2, groupStatus: "Public", location: "South Boston/Dorchester, MA", membersCount: "38 Members", duration: "June 10-14", sponsoredPosts: "13", sponsoredEvents: "3" },
        { id: 3, groupName: "Craft Beer Breweries", imageName: pastgroupimg3, groupStatus: "Public", location: "South Boston/Dorchester, MA", membersCount: "21 Members", duration: "June 10-14", sponsoredPosts: "13", sponsoredEvents: "3" },
    ])
    return (
        <>
            <div>
...
export default SponsorshipGroupsPastTab