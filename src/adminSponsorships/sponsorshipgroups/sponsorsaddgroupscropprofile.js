...
const SponsorsInfooAddcropDemo = () => {
...
<div className="mb-1">
       <InputRange  
        ...
        /> </div> */}
            ...
            <div>
              <img src={croppedImage != undefined ? croppedImage : blankimagees} width="359px" height="359px" style={{ borderRadius: '10px' }}></img>

              <input className="d-none" type="file" accept='.jpg,.png' ref={inputRef} onChange={onFileChange} onClick={handleShow}></input>
              <img src={editcamera} width="66px" height="66px" style={{ marginTop: "0%", marginLeft: "-30%" }} onClick={handleUpload}></img>
              <span className="font-white-camera  absolutivelyyy mb-5 pb-3">Tap to upload an image or video</span>
      ...
      {/* ) : (
        ...
        <div>
          <img src={croppedImage == undefined ? blankimagees : croppedImage} width="359px" height="359px" style={{ borderRadius: '10px' }}></img>
...
export default SponsorsInfooAddcropDemo;
