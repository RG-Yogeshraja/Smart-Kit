...
import editsponsorinfoimg from '../../assets/images/dashboardimg/editsponsorinfoimg.png'
import addnewimage1 from '../../assets/images/dashboardimg/addnewimage1.png'
import '../../../src/@core/scss/base/adminDashboard/sponsorshipsmenu/sponsorgroupsmenu/sponsorgroupsmain.scss'
import SponsorsgroupsInfooEditcropDemo from './sponsorsinfoeditcropprofile2'
...
const SponsorshipGroupsEditInfoTab = (props) => {
    ...
    return (
        <div>
            ...
            <div className="d-flex flex-column aaaa" style={{ width: "50%" }}>
                    {/* <img className="" src={editsponsorinfoimg} width="320px" height="310px" />
                    <img className="ms-auto addnewimage-section1" src={addnewimage1} width="56px" height="56px" /> */}
                    <SponsorsgroupsInfooEditcropDemo></SponsorsgroupsInfooEditcropDemo>
                </div>
            <div className='row mt-4'>
                <div className='col-6 d-flex flex-column'>
                    <span className='sponsor-textcomon'>Sponsor Name</span>
                    <input className='formControl sponsorship_innertext  mt-50' placeholder='Add Sponsor name...' defaultValue="Chewy" style={{ border: "1px solid #ECECEC" }}></input>
                </div>
                <div className='col-6'>
                    <span className='sponsor-textcomon'>Sponsor URL</span>
                    <input className='formControl sponsorship_innertext mt-50' placeholder='Add Sponsor URL...' defaultValue="www.chewy.com" style={{ border: "1px solid #ECECEC" }}></input>
                </div>
            </div>
...
export default SponsorshipGroupsEditInfoTab