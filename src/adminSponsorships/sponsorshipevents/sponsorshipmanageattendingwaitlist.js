...
const SponsorshipManageAttendingWaitlist = () => {
                        ...
                        return (
                            <div className=" row ">
                                ...
                                <div className="col-1 d-flex justify-content-center align-items-center">
                                    ...
                                    <Dropdown className="waitlistattend-dropdown">
                                        <Dropdown.Toggle>
                                            {/* <img className="pending-update" src={verticalmore} width="28px" height="28px" /> */}
                                            <img src={verticalmore} width="28px" height="28px" />
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu className="waitlistattend-dropdownmenu">
                                            <Dropdown.Item href="#" className="waitlistattend-dropdownitem d-flex align-items-center" onClick={() => removeFriend(data.id)}>
                                                <span className="addtoattend">
                                                    <img className="waitlistattend-dropdownitemIcon" src={vectorplus} width="10px" height="10px"></img>
                                                </span>
                                                <span style={{ paddingTop: "2px" }} className="waitlistattend-dropdownitemName">Add to Addending</span>
                                            </Dropdown.Item>
                                            <Dropdown.Item href="#" className="waitlistattend-dropdownitem d-flex align-items-center">
                                                <span>
                                                    <img className="waitlistattend-dropdownitemIcon" src={closeblock} width="16px" height="16px"></img>
                                                </span>
                                                <span style={{ paddingTop: "2px" }} className="waitlistattend-dropdownitemName">Block</span>
                                            </Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                ...
                                <div className="mt-50" style={{ display: index !== manageAttendigList.length - 1 ? '' : 'none' }}>
                                    <hr style={{ border: "1px solid #CCD8DB" }}></hr>
                                </div>
...
export default SponsorshipManageAttendingWaitlist