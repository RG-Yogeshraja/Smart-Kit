...
import SponsorshipLocation from './sponsorshiplocation'
...
const SponsorFilterpopup = (props) => {
...
<div className='mx-1 mb-1'>Comedy and Friends</div>
<div className='mx-1 mb-1'>Comedians for Life</div>
</div>
<div className='mt-2'>
  <span className='copy_as_text'>Event Type</span>
</div>
<div className=''>
<div className='row'>
...
<hr style={{borderTop:"1px solid #CCD8DB"}} className="mt-2"></hr>
<div className='mt-2'>
  <span className='copy_as_text'>Sponsorship Location</span>
</div>
<SponsorshipLocation></SponsorshipLocation>
<FiltergrpWithin></FiltergrpWithin>
<hr style={{borderTop:"1px solid #CCD8DB"}} className="mt-2"></hr>
<div className='mt-2'>
  <span className='copy_as_text'>Event Location</span>
</div>
<SponsorshipLocation></SponsorshipLocation>
<FiltergrpWithin></FiltergrpWithin>
<hr style={{borderTop:"1px solid #CCD8DB"}} className="mt-2"></hr>
<div className=''>
  <span className='copy_as_text'>Number of Spots</span>
</div>
...
{spots.map((data, index) => {
 ...
 <div className='col-6 d-flex align-items-center'>
  <img className='me-25' onClick={() => checkboxspot(index)} src={data.checked === true ? checked : checkblankbox} width="20px" height="20px"></img>
  <span className='text_font_checkbox'>{data.name}</span>
  </div>                                     
...
<div className='mt-2'>
  <span className='copy_as_text'>Event Name</span>
</div>
...
<hr style={{borderTop:"1px solid #CCD8DB"}} className="mt-2"></hr>
<div className='mt-2'>
  <span className='copy_as_text'>Event Date</span>
</div>
<div className='row mt-1'>
...
<hr style={{borderTop:"1px solid #CCD8DB"}} className="mt-2"></hr>
<div className='mt-2'>
  <span className='copy_as_text'>Event Creation Date</span>
</div>
<div className='row mt-1'>
...
<hr style={{borderTop:"1px solid #CCD8DB"}} className="mt-2"></hr>
<div className='mt-2'>
  <span className='copy_as_text'>Members Attending</span>
</div>
<div className='row mt-1'>
...
export default  SponsorFilterpopup