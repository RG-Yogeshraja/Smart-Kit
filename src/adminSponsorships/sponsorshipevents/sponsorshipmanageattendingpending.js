...
import closeitem from "../../../src/assets/images/dashboardimg/closeitem1.png"
import dropmessageicon from '../../../src/assets/images/dashboardimg/dropmessageicon.png'
...
const SponsorshipManageAttendingPending = () => {
    ...
    const [manageAttendigList] = useState([
        ...
        { id: 2, imageName: userfriend2, attendingName: "Alex Hardy", status: "", statusEnable: "", location: "Abington", birthDate: "34", reason1: "1. Have you ever been to a Don't Tell Comedy show?", reason1ans: "No", reason2: "2. Because you selected no, why not?", reason2ans: "N/A - have never been to DTC" },
                    ...
                    {manageAttendigList.map((data, index) => {
                        return (
                            <div className=" row ">
                                ...
                                <div className="col-8 attending-profilesection">
                                ...
                                <div className="col-3 d-flex justify-content-end align-items-center">
                                    <img className="pending-update" src={closeitem} width="28px" height="28px" />
                                    <img className="pending-update" src={tickboxpending} width="28px" height="28px" />
                                    {/* <img className="pending-update" src={verticalmore} width="28px" height="28px" /> */}
                                    ...
                                    <Dropdown className="pendingattend-dropdown">
                                        <Dropdown.Toggle>
                                            {/* <img src={verticalmore} width="28" height="28" /> */}
                                            <img className="pending-update" src={verticalmore} width="28px" height="28px" />
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu className="pendingattend-dropdownmenu">
                                        <Dropdown.Item href="#" className="pendingattend-dropdownitem d-flex align-items-center" onClick={() => removeFriend(data.id)}>
                                                <span>
                                                    <img className="pendingattend-dropdownitemIcon" src={dropmessageicon} width="16px" height="16px"></img>
                                                </span>
                                                <span style={{ paddingTop: "2px" }} className="pendingattend-dropdownitemName">Message</span>
                                            </Dropdown.Item>
                                            <Dropdown.Item href="#" className="pendingattend-dropdownitem d-flex align-items-center" onClick={() => removeFriend(data.id)}>
                                                <span>
                                                    <img className="pendingattend-dropdownitemIcon" src={deleteitem} width="16px" height="16px"></img>
                                                </span>
                                                <span style={{ paddingTop: "2px" }} className="pendingattend-dropdownitemName">Remove</span>
                                            </Dropdown.Item>
                                            <Dropdown.Item href="#" className="pendingattend-dropdownitem d-flex align-items-center">
                                                <span>
                                                    <img className="pendingattend-dropdownitemIcon" src={closeblock} width="16px" height="16px"></img>
                                                </span>
                                                <span style={{ paddingTop: "2px" }} className="pendingattend-dropdownitemName">Block</span>
                                            </Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>
...
export default SponsorshipManageAttendingPending