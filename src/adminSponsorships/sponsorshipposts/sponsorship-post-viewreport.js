    ...
    return (
        <>
            ...
            <Modal show={show1} centered dialogClassName="activeEventSendReport-custommodal" onHide={() => setShow1(false)}>
                <div className="post-sendReportSection p-2">
                    <div className="mt-50">
                        <span className="sponsor-textspanbold22" style={{ fontWeight: "500" }}>Barry's Post </span>
                    ...
                    <div className="d-flex align-items-center justify-content-between mt-2 mb-1">
                        <span className="sponser-textspanbold4">Reactions & Comments</span>
                        <div className="postevent-expressionSection">
                            <div className="p-0 d-flex align-items-center justify-content-end">
                                ...
                                <img className="me-50 ms-25" src={message} width="16px" height="16px" style={{ cursor: "pointer" }} />
