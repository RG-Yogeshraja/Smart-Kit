...
import sponsoreventsimage1 from '../../../src/assets/images/dashboardimg/hssponsorpostimg1.png'
...
import defaultpostimg from '../../../src/assets/images/dashboardimg/defaultpostimage.png'
...
const SponsorsPostsInfooEditcropDemo1 = (props) => {
  ...
  const resetbuttonbox = () => {
    ...
    setCroppedImage(defaultpostimg)
    setimages('')
    getdefault(true)
    props.handle1('Reset')
      ...
      {image && (
        <React.Fragment>
          ...
          <div className='btn1'>
           ...
           <div className='row'>
        <div className='col-6'>
          <img src={croppedImage != undefined ? croppedImage : sponsoreventsimage1} width="300px" height="358px" style={{ borderRadius: '10px' }}></img>
...
export default SponsorsPostsInfooEditcropDemo1;
