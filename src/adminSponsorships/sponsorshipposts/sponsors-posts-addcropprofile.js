...
const SponsorsPostsAddcropDemo = (props) => {
...
<div className='row'>
        <div className='col-6'>
          ...
          <span className='font-white-camera  absolutivelyyys' style={{ display: croppedImage !== null ? 'none' : 'flex' }}>Tap to upload images or videos</span>
        </div>
...
export default SponsorsPostsAddcropDemo;
