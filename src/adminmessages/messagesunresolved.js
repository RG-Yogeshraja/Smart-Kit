...
const MessagesUnresolved = () => {
    const [activeGroupData] = useState([
        { id: 1, reportName: "Amy Delacruz", reportName1: "Secret Comedy Show", num:'1', reportStatus:' Having an issue with account', reportStatus1: "jreed@gmail.com", duration: "June 27, 2022", time:'5:30 pm', phno:'445-334-3322'  },
        { id: 2, reportName: "Michelle Smith",  reportName1: "Pickleball Group", num:'1', reportStatus:' Can’t access all the features in the app', reportStatus1: "msmith@gmail.com",duration: "June 27, 2022",time:'5:30 pm',  phno:'445-334-3322' },
        { id: 3, reportName: "Rebecca Jackson", reportName1: "Hint Social Meet Up",  num:'', reportStatus:' Having an issue with account',reportStatus1: "rjack@gmail.com", duration: "June 27, 2022",time:'5:30 pm',  phno:'445-334-3322' },
        { id: 4, reportName: "Michelle Smith",  reportName1: "Secret Comedy Show",  num:'', reportStatus:' Having an issue with account',reportStatus1: "msmith@gmail.com",  duration: "June 27, 2022",time:'5:30 pm',  phno:'445-334-3322'  },
        { id: 5, reportName: "Rebecca Jackson",  reportName1: "Secret Comedy Show",  num:'', reportStatus:' Having an issue with account',reportStatus1: "rjack@gmail.com",  duration: "June 27, 2022",time:'5:30 pm',  phno:'445-334-3322'  },
    ])
    return (
        <>
            <div>
...
export default MessagesUnresolved