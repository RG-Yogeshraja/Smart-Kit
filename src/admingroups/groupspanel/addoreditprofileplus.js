...
const AddgroupsCropDemo = (props) => {
  ...
  const [getheight, setheight] = useState('398px')
...
<div className="mb-1">
      ...
      <div className='row'>
        <div className='col-6'>
          <img src={croppedImage != undefined ? croppedImage : edituser1} width="332px" height={getheight} onClick={handleUpload} style={{ borderRadius: '10px' }}></img>
